const Spieler1 = '<ion-icon name="logo-xbox"></ion-icon>';
const Spieler2 = '<ion-icon name="book-sharp"></ion-icon>';
...
function handleclick(fieldid)
{
    if(isGameRunning)
    {
        ...
        if(field[parseInt(fieldid)] == "e")
        {
            ...
            document.getElementById(fieldid).innerHTML = Spieler1;
            checkForWinner();
            SetCircle();
        }
    }
...
function SetCircle()
{
    ...
    if(field[parseInt(fieldid)] == "e")
    {
        ...
        document.getElementById(fieldid).innerHTML = Spieler2;
        checkForWinner();
    }
    else
    {
...
function reset()
{
    ...
    document.getElementById("status").innerHTML = "Bereit zum Spielen";
        document.getElementById("card").style.backgroundColor = "#058585";
        isGameRunning = true
